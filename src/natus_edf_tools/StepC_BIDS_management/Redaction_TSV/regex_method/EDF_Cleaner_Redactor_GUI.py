...
try:
    from natus_edf_tools.StepC_BIDS_management.Redaction_TSV.regex_method.edf_embedded_annotations_redactor_blanker import (
    ...
    print("Error: Could not import edf_embedded_annotations_redactor_UPDATED.py")
