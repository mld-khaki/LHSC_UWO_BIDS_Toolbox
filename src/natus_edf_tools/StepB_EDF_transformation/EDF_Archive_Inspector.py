...
# ══════════════════════════════════════════════════════════════════════════════
#  ARCHIVE STREAMING  — imported from common_libs
#  Canonical source: src/common_libs/archiving/edf_archive_peek.py
# ══════════════════════════════════════════════════════════════════════════════

# EDF_Archive_Inspector lives at:
#   src/natus_edf_tools/StepB_EDF_transformation/EDF_Archive_Inspector.py
# Two levels up from here → natus_edf_tools/ ; one more → src/
