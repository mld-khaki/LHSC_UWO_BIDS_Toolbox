...
# Configuration
MAIN_FOLDER = r'y:\_pipeline\_AutoFLD_NatusInp'
DEST_FOLDER = r'y:\_pipeline\_AutoFLD_NatusOut'
ARCHIVE_FOLDER = r'y:\_pipeline\_AutoFLD_NatusArx'
EDFEXPORT_PATH = r'd:\Neuroworks\EDFExport.exe'
CHECK_INTERVAL = 10  # in seconds
WAIT_INTERVAL = 3  # in seconds
    ...
    while True:
        for folder in os.listdir(MAIN_FOLDER):
	        ...
	        time.sleep(WAIT_INTERVAL)
                ...
                if os.path.isdir(folder_path):
                    print(f"Running conversion for folder <{folder_path}>")
