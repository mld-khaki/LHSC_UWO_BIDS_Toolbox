...
tools = {
    ...
    "./Modules/StepA0_NatCheck/Natus_InfoExtractor_v2": {
        "usage": "Natus_InfoExtractor.py [-h] [-o OUTPUT] input_dir",
        "args": ["-o OUTPUT (File)", "input_dir (Folder)"],
        "arg_name": ["-o", ""]
    },
    "./Modules/StepA1_Nat2EDF/NatusExportList_Generator": {
    ...
    "./Modules/StepE0_Arxive/TSV_Participant_Merger": {
    ...
    "./OtherTools/comparison__TextList_Folder": {
        "usage": "TextList_Folder_Comparison.py folder txtfile",
        "args": ["folder (Folder)","txtfile (File)"],
        "arg_name": ["",""]
    },
    "./Modules/StepC3_BIDS_Redaction/EDF_Anonymization_Scanner": {
    ...
    "./Modules/StepD4_Verification/comparison_two_massive_files": {
        "usage": "python compare_files_visual.py <file1> <file2>",
        "args": ["python (File)","file1 (File)","file2 (File)"],
        "arg_name": ["","",""]},
        
    "./Modules/StepA0_NatCheck/Server_update_check": {
    ...
    "./Modules/StepD4_Verification/TSV_dates_checker": {
   ...
   "Natus_TimeValue_Converter": {
    ...
    "./Modules/StepW_Provenance/Natus_Log_Parser": {
    ...
    "./Modules/StepA3_NatusFiles_CleanUp/FolderFile_NameCheck": {
    ...
    "./Modules/StepZ_EDF_Clipping/EDF_time_calculator": {
    ...
    "./Modules/StepA2_EDFCompatChk/EDF_Compatibility_Check_Tool": {
    ...
    "./Modules/StepB0_Eval/EDF_dir_scanner_renamer": {
    ...
    "./Modules/StepA3_NatusFiles_CleanUp/EDF_step_A_post_edf_archiver_cleanup": {
        "usage": "EDF_step_A_post_edf_archiver_cleanup.py [--folder_a] [--folder_b] [--dry-run / --real-del-mode]",
        "args": [
    ...
    "./Modules/StepC3_BIDS_Redaction/redactor_EDF_EmbeddedAnnotations": {
    ...
    "./Modules/StepC5_CleanUp_PostBIDS/EDF_BIDS_Cleanup_Archive_post_step_C": {
